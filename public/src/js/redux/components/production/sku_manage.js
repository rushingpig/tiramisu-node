            ...
            <FormHorizontal>
                <FormGroup>
                    ...
                    <Col xs='10'>
                        <p>
                            <label className="radio-inline">
                              <input type="radio" name="bbb" value="0" />{' 全部一致'}
                            </label>
                            {'　　'}
                            <label className="radio-inline">
                              <input type="radio" name="bbb" value="1" />{' 独立配置'}
                            </label>
                        </p>
                    </Col>
                </FormGroup>
                        ...
                        <table className="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div className="form-inline">
                                            <Input style={{width:130,textAlign:'center'}} defaultValue="2016-04-03 00:00:00" />{' 至 '}<Input style={{width:130,textAlign:'center'}} defaultValue="2016-04-03 00:00:00" />
                                        </div>
                                    </td>
                                    <td><button className="btn btn-xs btn-danger">{'×'}</button></td>
                                </tr>
