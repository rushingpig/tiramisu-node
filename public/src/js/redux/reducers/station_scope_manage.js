...
import { GOT_STATIONS , GOT_STATIONS_BY_CITY, GOT_STATIONS_BY_DISTRICT,
  GOT_STATIONS_BY_NAME, GOT_STATIONS_SCOPE, MODIFY_STATIONS_SCOPE } from 'actions/station_scope_manage';
...
export function station(state = initial_state, action){
  switch (action.type) {
    ...
    case GOT_STATIONS_BY_DISTRICT:
      return { ...state, station_list_info: action.data};
